...
// This is a class meant to be called in another opmode
...
public class VuforiaSkyStone {
    ...
    public VuforiaSkyStone () {
        ...
        // TODO: Update these values. I updated them based on the CAD but it should be checked on the actual robot.
        final float CAMERA_FORWARD_DISPLACEMENT  = 4.0f * mmPerInch;   // eg: Camera is 4 Inches in front of robot center
        final float CAMERA_VERTICAL_DISPLACEMENT = 135f;   // eg: Camera is 8 Inches above ground
        final float CAMERA_LEFT_DISPLACEMENT     = 153.17f;     // eg: Camera is ON the robot's center line
